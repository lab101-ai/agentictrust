...
from .helpers import get_agentictrust_version
from .log_config import logger

def get_sdk_details():
    try:
        return {
            "AgentOps SDK Version": get_agentictrust_version(),
...
def get_agentops_details():
    try:
        return {"AgentOps SDK Version": get_agentictrust_version()}
    except:
        return {}
...
def get_host_env(opt_out: bool = False) -> dict:
    if opt_out:
        return {
            "SDK": get_sdk_details(),
            "OS": get_os_details(),
