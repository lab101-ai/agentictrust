...
class AgenticTrustClient:
    ...
    def delegate_token_with_mfa(self, client_id: str, delegator_token: str, scopes: List[str], 
                               mfa_challenge_id: str, mfa_code: str,
                               task_description: Optional[str] = None, task_id: Optional[str] = None, 
                               parent_task_id: Optional[str] = None, purpose: Optional[str] = None,
                               constraints: Optional[Dict[str, Any]] = None, 
                               agent_instance_id: Optional[str] = None):
        """Request a delegated token with MFA verification."""
        url = f"{self.base_url}/api/oauth/delegate/mfa"
    ...
    def setup_mfa(self, user_id: str):
        ...
        url = f"{self.base_url}/api/mfa/users/{user_id}/setup"
    ...
    def verify_mfa(self, user_id: str, code: str):
        """Verify MFA code."""
        url = f"{self.base_url}/api/mfa/users/{user_id}/verify"
    ...
    def create_mfa_challenge(self, user_id: str, operation_type: str):
        """Create MFA challenge for critical operation."""
        url = f"{self.base_url}/api/mfa/users/{user_id}/challenge"
    ...
    def verify_mfa_challenge(self, user_id: str, challenge_id: str, code: str):
        """Verify MFA challenge."""
        url = f"{self.base_url}/api/mfa/users/{user_id}/challenge/verify"
