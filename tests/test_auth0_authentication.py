...
def test_auth0_config(mock_auth0_client):
    ...
    from app.core.auth.auth0 import auth0_config
...
@mock.patch("app.core.auth.auth0.OAuth")
...
@mock.patch("app.core.auth.auth0.requests.get")
def test_verify_auth0_token(mock_get, mock_auth0_response):
    """Test Auth0 token verification."""
    from app.core.auth.auth0 import verify_auth0_token
